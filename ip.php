...
$type = isset($_GET['type']) ? $_GET['type'] : 'dump';

//经测试，以下典型的ip地址可以正常识别
//60.6.255.43    中国河北省邢台市桥西区绿茵网吧(冶金路)
//222.35.183.92  中国北京朝阳区铁通ADSL
//60.6.218.16    中国河北省邢台市威县新科网吧(北外街)
//60.194.228.230 中国北京丰台区蒲黄榆舒平网吧
...
//$ipope->out_charset = 'UTF-8';//默认都是UTF-8了吧
...
switch ($type) {
    ...
    case 'dump':
        ...
        break;
    case 'js':
        echo 'var location=' . json_encode($location);
        break;
    case 'getfile':
