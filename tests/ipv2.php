...
require dirname(__DIR__) . '/src/IpLocationInterface.php';
require dirname(__DIR__) . '/src/parser/IpParserInterface.php';

require dirname(__DIR__) . '/src/IpLocationV2.php';
...
foreach ($ips as $ip) {
    echo json_encode(IpLocationV2::getLocation($ip), JSON_UNESCAPED_UNICODE) . "\n";
}
